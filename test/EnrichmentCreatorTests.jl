...
@testset "EnrichmentCreatorTests" begin
    ...
    @testset "create_wavenumbers" begin
        @testset "enrichments" begin
            ...
            actual_wavenumbers =
                wavenumber_func.create_wavenumbers(x_enrichments, y_enrichments)
    ...
    @testset "Edge Cases - Empty Vectors" begin
        ...
        @test_throws ArgumentError wavenumber_func.generate_pairs(
            vector1_empty,
            vector1_empty,
        )      # Test for ArgumentError when both are empty
    end
