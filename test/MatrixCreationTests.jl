...
function setup_test_environment(; wave_x::Int64 = 0, wave_y::Int64 = 0, zero_frequencies ::Bool = false)
    """
...
@testset "Matrix Creation" begin
    ...
    @testset "mass_jump_enriched_noFrequencies" begin
        ...
        all_pairs,
        idx_connectivity,
        wave_node_pairs = setup_test_environment(wave_x = 1, wave_y = 1, zero_frequencies = true)
        ...
        exact_matrix = conj(load_matlab_matrix("test/testdata/MassMatrixEnriched_noFrequencies.txt")) #! This conjudate is simply as the matlab code orders in a differnet way
